...
class armar_pdf():
    ...
    def escribir(list_diccionario, ruta):
        pdf = PDF()
        pdf.alias_nb_pages()
        pdf.add_page()
        ...
        for dicc in list_diccionario:
            ...
            while i < (len(dicc['Respuesta'][0]) - 10):
                ...
                pdf.cell(0, 15, 'Error  || ----- ' + str(dicc['Respuesta'][6][i]) + ' ----- ' + str(
                    ...
                    dicc['Respuesta'][6][i + 7]) + ' ----- ' + str(dicc['Respuesta'][6][i + 8]) + ' ----- ' + str(
                    dicc['Respuesta'][6][i + 9]) + ' ----- | ', 0, 1)
                i += 10
    ...
    def main(diccionario):
        ...
        armar_pdf.escribir(armar_pdf.dicc_to_pdf(diccionario['tablatura']), diccionario['ruta'])
        # print("TERMINE")
        return True
